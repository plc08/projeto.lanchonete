...
from apresentacao.tela_pagamentos import TelaPagamentos
from apresentacao.tela_usuarios import TelaUsuarios
...
class MainWindow(ctk.CTk):
    ...
    def mostrar_dashboard(self):
        ...
        TelaDashboard(self.corpo).pack(fill="both", expand=True)
    ...
    def mostrar_produtos(self):
        ...
        TelaProdutos(self.corpo).pack(fill="both", expand=True)
    ...
    def mostrar_mesas(self):
        ...
        TelaMesas(self.corpo).pack(fill="both", expand=True)

    # =========================================

    def mostrar_pedidos(self):

        self.titulo_topo.configure(text="Pedidos")

        self.limpar_corpo()

        TelaPedidos(self.corpo).pack(fill="both", expand=True)
    ...
    def mostrar_pagamentos(self):
        ...
        tela = TelaPagamentos(self.corpo)
